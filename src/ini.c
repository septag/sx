...
void sx_ini_property_add(sx_ini* ini, int section, char const* name, int name_length,
...
void sx_ini_property_name_set(sx_ini* ini, int section, int property, char const* name,
                              int length) {
